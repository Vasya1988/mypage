    ...
    return (
        ...
        >
            ...
            <div className={classes.Social}>
                <a target="_blank" href='https://www.instagram.com/vasiliy_romanov_88/?hl=ru'><img src={props.icons.instagramLogo} /></a>
                <a target="_blank" href='https://www.facebook.com/profile.php?id=100001263317483'>
                ...
                <a target='_blank' href='https://github.com/Vasya1988'><img src={props.icons.icons[5].src} /></a>
            </div>
        </div>
    )
}
